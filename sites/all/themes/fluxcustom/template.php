 ...
 */
function fluxcustom_html_head_alter(&$head_elements) {
 ...
 */
function fluxcustom_breadcrumb($variables) {
 ...
 */
function fluxcustom_menu_local_tasks(&$variables) {
  $output = '';
 ...
 */
function fluxcustom_preprocess_node(&$variables) {
 ...
 */
function fluxcustom_preprocess_region(&$variables, $hook) {
 ...
 */
function fluxcustom_preprocess_block(&$variables, $hook) {
 ...
 *   The name of the template being rendered ("block" in this case.)
 */
function fluxcustom_process_block(&$variables, $hook) {
...
function fluxcustom_preprocess_page(&$vars) {
...
function fluxcustom_css_alter(&$css) {
 ...
 */
function fluxcustom_preprocess_search_block_form(&$vars) {
 ...
 */
function fluxcustom_field($variables) {
  $output = '';
 ...
 */
function fluxcustom_preprocess_field(&$variables, $hook){
