 ...
 */
function fluxcustom_form_system_theme_settings_alter(&$form, &$form_state) {
  // Container fieldset
  ...
  // cover_photo settings
    ...
    $form['#submit'] = array('fluxcustom_theme_settings_submit');
    $form['#validate'] = array('fluxcustom_theme_settings_validate');
}
 ...
 * Submit handler
 */
function fluxcustom_theme_settings_submit($form, &$form_state) {
  ...
  if (!empty($values['cover_photo_path'])) {
    $values['cover_photo_path'] = fluxcustom_system_theme_settings_validate_path($values['cover_photo_path']);
  }


  $key = 'theme_fluxcustom_settings';//$values['var'];
 ...
 */
function fluxcustom_theme_settings_validate($form, &$form_state) {
  // Handle file uploads.
  ...
  if ($form_state['values']['cover_photo_path']) {
    $path = fluxcustom_system_theme_settings_validate_path($form_state['values']['cover_photo_path']);
    if (!$path) {
 ...
 */
function fluxcustom_system_theme_settings_validate_path($path) {
